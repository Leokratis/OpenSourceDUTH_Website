...
import { Calendar } from '@/components/ui/calendar-food';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from '@/components/ui/popover-food';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Switch } from '@/components/ui/switch-food';
import { monthlySchedule } from '@/lib/schedule';
import { el as elLocale } from 'date-fns/locale';
import { Info } from 'lucide-react';
import { RestaurantStatus } from '@/components/food/RestaurantStatus';
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center p-4">
      ...
      <div className="flex items-center space-x-4 mb-5 ">
        <Button variant="outline" size={"icon" as ButtonProps['size']} onClick={handlePrevDay}> {/* Cast size prop */}
        ...
        <Button variant="outline" size={"icon" as ButtonProps['size']} onClick={handleNextDay}> {/* Cast size prop */}
